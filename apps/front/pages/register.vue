  ...
  <div>
    ...
    <div pt-32>
      <form flex="~ col" space="y-4" border="rounded-lg" bg="opacity-30 light-100" backdrop="blur-sm" m="x-auto" w="4/5 lg:1/4" p="8" @submit.prevent="onSubmit">
        ...
        <input v-model="form.email" placeholder="Email" type="email" name="email" required p="2" border="rounded-lg gray-300 1">
        <input v-model="form.username" placeholder="Username" type="text" name="username" required p="2" border="rounded-lg gray-300 1">
